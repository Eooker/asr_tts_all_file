...
##################################单独测试此文件时可将第95、100、138、140、97、93行的注释去掉，以查看错误输出信息

# 需要识别的文件
AUDIO_FILE = '/home/pi/my_ASR_TTS/input/input.wav'  # 只支持 pcm/wav/amr 格式，极速版额外支持m4a 格式
#AUDIO_FILE = '/home/pi/Baidu_yuyinshibie_dome/speech-demo-master/rest-api-tts/python/result.mp3'
# 文件格式
...
if __name__ == '__main__':
    ...
    if result_dict['err_msg']=='success.':
        result_txt=result_dict['result'][0]
    else:
